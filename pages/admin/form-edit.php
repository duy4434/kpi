    <?php 
        ...
        $id = $_GET['id'];
        $sql = "SELECT first_name,last_name,email,cid,tel,username,password,status  FROM `admin` WHERE `id` = '".$id."' ";
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item"><a href="../admin">เพิ่มผู้ใช้งาน</a></li>
              ...
              <div class="card-body">
                   ...
                   <div class = "col-4">
                      <div class="form-group">
                         <label for="email">E-mail</label>
                            <input type="text" class="form-control" name= "email" id="email" placeholder="Email" value="<?php echo $row ['email'];?>"required>
                          </div>
                      </div>
                   </div>
                  <div class ="row">
                    <div class = "col-6">
                        <div class="form-group">
                            <label for="cid">หมายเลขบัตรประชาชน</label>
                              <input type="text" class="form-control" name= "cid"  id="cid" placeholder="cid"value="<?php echo $row ['cid'];?>" required>
                        </div>
                    </div>
                  <div class = "col-6">
                     <div class="form-group">
                ...
                <div class="form-group">
                        <label for="password">รหัสผ่านเข้าใช้งาน</label>
                           <input type="password" disabled class="form-control" name= "password" id="password" placeholder="Password" value="<?php echo $row ['password'];?>"required >
                        </div>
                        <div class="form-group">
              <label>เลือกแผนก</label>
              <select class="form-control" required name ="dep_name">
              <option value=" "disableed >เลือกแผนก</option>
