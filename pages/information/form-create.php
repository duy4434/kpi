  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card card-primary">
        ...
        <h3 class="card-title">จัดการแผนก</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="create.php" method="post">
          <div class="card-body">
             <div class ="row">
                ...
                <div class = "col-12">
                  <div class="form-group">
                   <label for="hos_guid">ชื่อเรียก</label>
                     <input type="text" class="form-control" name= "hos_guid" id="hos_guid" placeholder="ชื่อเรียก" required>
                  </div>
              </div>  
          </div>
